...
contract TestYANFManagerPublishing {
  ...
  function testPublishing() public {
    ...
    bool result = manager.publish(title, contentHash, coauthors, parts, price);
    Assert.equal(result, true, "Publish must go on");
  }
